...
class TwoVotersQuestion(VotingTestCase):
    ...
    def setUp(self):
        super().setUp()
        Profile.objects.create(user=User.objects.create(username="voter2"))
...
class AnswerQuestionTestCase(APITestCase):
    ...
    def test_no_login(self):
        data = {"text": "No more", "show_username": False}
    ...
    def test_invalid_data(self):
        ...
        data_without_text = {"show_username": False}
...
class PutQuestionTestCase(APITestCase):
    ...
    def test_no_login(self):
        data = {"title": "Test title", "text": "Test text", "tags": ["test", "put"]}
...
class EditAnswerTestCase(APITestCase):
    ...
    def test_edit_text_no_login(self):
        answer_id = Answer.objects.get(text="Ring-ding-ding-ding-dingeringeding!").id
        url = reverse("answers-detail", args=[answer_id])

        data = {"text": "Hatee-hatee-hatee-ho!"}
...
class AcceptAnswerTestCase(APITestCase):
    ...
    def test_accept_answer_no_login(self):
        answer_id = Answer.objects.get(text="Hatee-hatee-hatee-ho!").id
...
class DeleteAnswerTestCase(APITestCase):
    ...
    def test_delete_own_answer(self):
        ...
        answer_id = Answer.objects.get(owner__user=answer_submitter).id
        url = reverse("answers-detail", args=[answer_id])
    ...
    def test_delete_other_user(self):
        ...
        answer_id = Answer.objects.get(owner__user__username="answer_submitter_0").id
        url = reverse("answers-detail", args=[answer_id])
